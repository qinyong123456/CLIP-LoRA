#!/bin/bash
#SBATCH --job-name=CLIP-LoRA_eurosat_4shots
#SBATCH --output=logs_scripts/CLIP-LoRA_eurosat_4shots.out
#SBATCH --error=error_scripts/CLIP-LoRA_eurosat_4shots.err
#SBATCH --mem=32G
