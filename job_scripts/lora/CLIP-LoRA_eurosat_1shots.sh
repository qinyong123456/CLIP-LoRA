#!/bin/bash
#SBATCH --job-name=CLIP-LoRA_eurosat_1shots
#SBATCH --output=logs_scripts/CLIP-LoRA_eurosat_1shots.out
#SBATCH --error=error_scripts/CLIP-LoRA_eurosat_1shots.err
#SBATCH --mem=32G
