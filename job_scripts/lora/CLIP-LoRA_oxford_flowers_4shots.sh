#!/bin/bash
#SBATCH --job-name=CLIP-LoRA_oxford_flowers_4shots
#SBATCH --output=logs_scripts/CLIP-LoRA_oxford_flowers_4shots.out
#SBATCH --error=error_scripts/CLIP-LoRA_oxford_flowers_4shots.err
#SBATCH --mem=32G
