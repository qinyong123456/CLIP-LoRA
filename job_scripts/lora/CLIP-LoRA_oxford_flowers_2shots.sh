#!/bin/bash
#SBATCH --job-name=CLIP-LoRA_oxford_flowers_2shots
#SBATCH --output=logs_scripts/CLIP-LoRA_oxford_flowers_2shots.out
#SBATCH --error=error_scripts/CLIP-LoRA_oxford_flowers_2shots.err
#SBATCH --mem=32G
