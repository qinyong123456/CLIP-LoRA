#!/bin/bash
#SBATCH --job-name=CLIP-LoRA_eurosat_2shots
#SBATCH --output=logs_scripts/CLIP-LoRA_eurosat_2shots.out
#SBATCH --error=error_scripts/CLIP-LoRA_eurosat_2shots.err
#SBATCH --mem=32G
