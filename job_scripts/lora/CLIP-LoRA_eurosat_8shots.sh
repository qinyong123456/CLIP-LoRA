#!/bin/bash
#SBATCH --job-name=CLIP-LoRA_eurosat_8shots
#SBATCH --output=logs_scripts/CLIP-LoRA_eurosat_8shots.out
#SBATCH --error=error_scripts/CLIP-LoRA_eurosat_8shots.err
#SBATCH --mem=32G
