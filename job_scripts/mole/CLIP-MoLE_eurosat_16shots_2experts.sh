#!/bin/bash
#SBATCH --job-name=CLIP-MoLE_eurosat_16shots_2experts
#SBATCH --output=logs_scripts/mole/CLIP-MoLE_eurosat_16shots_2experts.out
#SBATCH --error=error_scripts/mole/CLIP-MoLE_eurosat_16shots_2experts.err
#SBATCH --mem=32G
