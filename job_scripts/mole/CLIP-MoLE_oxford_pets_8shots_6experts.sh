#!/bin/bash
#SBATCH --job-name=CLIP-MoLE_oxford_pets_8shots_6experts
#SBATCH --output=logs_scripts/mole/CLIP-MoLE_oxford_pets_8shots_6experts.out
#SBATCH --error=error_scripts/mole/CLIP-MoLE_oxford_pets_8shots_6experts.err
#SBATCH --mem=32G
