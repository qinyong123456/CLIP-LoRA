#!/bin/bash
#SBATCH --job-name=CLIP-LoRA_oxford_flowers_16shots
#SBATCH --output=logs_scripts/CLIP-LoRA_oxford_flowers_16shots.out
#SBATCH --error=error_scripts/CLIP-LoRA_oxford_flowers_16shots.err
#SBATCH --mem=32G
