#!/bin/bash
#SBATCH --job-name=CLIP-LoRA_oxford_flowers_8shots
#SBATCH --output=logs_scripts/CLIP-LoRA_oxford_flowers_8shots.out
#SBATCH --error=error_scripts/CLIP-LoRA_oxford_flowers_8shots.err
#SBATCH --mem=32G
