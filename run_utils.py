...
def get_arguments():
    ...
    # Dynamic rank allocation (warmup-driven)
    parser.add_argument('--rank_strategy', type=str, default='uniform', choices=['uniform', 'warmup_dynamic'])
    parser.add_argument('--rank_warmup_iters', default=200, type=int)
    parser.add_argument('--rank_budget', default=32, type=int)
    parser.add_argument('--rank_min', default=0, type=int)
    parser.add_argument('--rank_max', default=8, type=int)
    parser.add_argument('--rank_scope', type=str, default='layer', choices=['layer'])
    parser.add_argument('--rank_by', type=str, default='grad_norm', choices=['grad_norm'])
