...
def get_arguments():
    ...
    # Static heuristic rank mapping
    parser.add_argument('--rank_strategy', type=str, default='uniform', choices=['uniform', 'static_map'])
    parser.add_argument('--rank_budget', default=32, type=int)
    parser.add_argument('--rank_high', default=8, type=int)
    parser.add_argument('--rank_mid', default=4, type=int)
    parser.add_argument('--rank_low', default=2, type=int)
    parser.add_argument('--rank_scope', type=str, default='layer', choices=['layer', 'matrix'])
    parser.add_argument('--dataset_rank_bias', type=str, default='auto', choices=['auto', 'none'])
